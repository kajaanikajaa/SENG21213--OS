...
static void print_splash(void)
{
    ...
    vga_puts("SENG21213 Stage 0 - Loading kernel...\n");
    ...
    vga_puts("| ");
    vga_puts_color("SENG 21213 - Stage 0 Kernel Shell", VGA_LIGHT_CYAN, VGA_BLACK);
    vga_puts("               |\n");

    vga_puts("| ");
    vga_puts_color("University of Kelaniya", VGA_YELLOW, VGA_BLACK);
    vga_puts("                          |\n");
...
static void cmd_version(const char *args) {
    ...
    vga_puts("  Kernel version: v0.1-stage0\n\n");
}
